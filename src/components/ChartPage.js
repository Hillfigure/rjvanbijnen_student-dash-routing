    ...
    <div className="App">
      ...
      <div className='graph-menu student-buttons'>
          ...
          {nameList.map(item => {
            ...
            return <NavLink key={item.name} to={"/" + item.name.toLowerCase()} state={{student: student}}>
                    <p style={{display: "inline-block"}} className='graph-menu student-buttons'>
                        <input type="radio" id={item.name} name="studentbutton" value={item.name} />
